...
// const email = 'brival1005@gmail.com';
...
// const firstName = 'Брикалов';
// const lastName = 'Валерій';
...
// const userValue = 512;
// const userValueString = userValue.toString();
// const result = userValue * ( 5 **  userValueString.length);
// console.log(result );
...
// console.log(result1); //Спочатку множення, потім додавання та віднімання
